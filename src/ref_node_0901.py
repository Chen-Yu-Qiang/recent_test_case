...
Target_all_position2=Twist()
def cb_target_all2(data):
    global Target_all_position2
    Target_all_position2=data
    Target_all_position2.linear.z=Target_all_position2.linear.z+0.5
    ...
    if is_takeoff:
        ...
        if m==5:
            if t>=5:
                ...
                ref_pub_msg=Twist()
                ref_pub_msg=p2p_mean(p1,Target51_position,5,t)
                ref_pub.publish(ref_pub_msg)
        if m==6:
            if t>=15:
                m=7
        ...
        if m==7:
            if t>=5:
                ...
                t=t+Ts
                ref_pub_msg=Twist()
                ref_pub_msg=p2p_mean(Target51_position,Target52_position,5,t)
                ref_pub.publish(ref_pub_msg)
        if m==8:
            if t>=15:
                m=9
        ...
        if m==11:
            if t>=5:
                ...
                t=t+Ts
                ref_pub_msg=p2p_mean(Target_all_position,Target_all_position2,5,t)
                ref_pub.publish(ref_pub_msg)
        if m==12:
            if t>=15:
                m=13
        ...
        if m==13:
            if t>=5:
                ...
                t=t+Ts
                ref_pub_msg=p2p_mean(Target_all_position2,Target_all_position,5,t)
                ref_pub.publish(ref_pub_msg)
        if m==14:
            if t>=15:
                m=15
